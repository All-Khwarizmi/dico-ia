...
from ui_text import *
from utils import TRADUCTIONS, add_system_prompt, get_system_prompt_id, add_llm_call_row, init_files, llm_call, update_last_row_quality_comments, check_and_add_system_prompt
import pandas as pd
from prompts import *
...
if st.button('Traduire'):
    ...
    response = llm_call(translation_direction, word_to_translate, MODE_NAME)
